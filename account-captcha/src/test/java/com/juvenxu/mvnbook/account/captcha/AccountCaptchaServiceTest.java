...
public class AccountCaptchaServiceTest {
	...
	public void testValidateCaptchaCorrect() throws Exception {
		...
		assertTrue(service.validateCaptchaImage(captchaKey, "12345"));
		
		captchaKey = service.generateCaptchaKey();
		service.generateCaptchaImage(captchaKey);
		assertTrue(service.validateCaptchaImage(captchaKey, "abcde"));
	}
	...
	public void testValidatCaptchaIncorrect() throws Exception {
		...
		String captchaKey = service.generateCaptchaKey();
		service.generateCaptchaImage(captchaKey);
		assertFalse(service.validateCaptchaImage(captchaKey, "87695"));
	}
}
